...
public class StudyPlanController implements ActionListener {
    ...
    FrameStudyPlan frameSP;
    PanelCRUD panelCRUD;
    PanelStudyPlanManagementAndMaintenance panelSPM;
    StudyPlan studyPlan;
    StudyPlanJpaController studyPlanJpaController;
    Careers carrers;
    FrameStudyPlanManagementMaintenance frameSPMM;
    StudyPlanTableController studyPlanTable;

    public StudyPlanController() {

        frameSPMM = new FrameStudyPlanManagementMaintenance();
        frameSP = new FrameStudyPlan(studyPlanTable);
        ...
        switch (e.getActionCommand()) {
            case "agregar":
                ...
                try {
                    ...
                    frameSP.showMessage("Fecha no válida. Por favor, ingrese la fecha en el formato dd-MM-yyyy.");
                ...
                if (idStudy_Plan.isEmpty() || description.isEmpty() || effective_date.isEmpty() || approval_date.isEmpty()) {
                    frameSP.showMessage("Por favor ingrese la informacion en todos los espacios para agregar un Plan de Estudio");
                } else {
                    ...
                    try {
                        ...
                        frameSP.showMessage("The Study Plan was successfully added to the database");
                    } catch (Exception ex) {
                        Logger.getLogger(StudyPlanManagementController.class.getName()).log(Level.SEVERE, null, ex);
                    }
            ...
            case "Consultar":
                ...
                frameSP.showMessage("ID de plan de estudio ingresado: " + idStudyPlan);
...
//                panelSPM.setDescriptionStudyPlanTxt(studyPlan.getDescription());
                if (studyPlan != null) {
                    frameSP.showMessage("prueba");
                    panelSPM.setDescriptionStudyPlanTxt(studyPlan.getDescription());
                } else {
                    frameSP.showMessage("El plan de estudio no se encuentra registrado");
                }
                ...
                studyPlan = new StudyPlan(newStudyPlanIdInt, newDescription, newEffectiveDate, newApprovalDate);
                 {
                    try {
                        ...
                        frameSP.showMessage("El plan de estudio fue modificado exitosamente");
                ...
                int studyPlanIdInt = Integer.parseInt(studyPlanId);
                 {
                    try {
                        ...
                        frameSP.showMessage("El plan de estudios fue eliminado correctamente");
                        panelSPM.setIdStudyNameTxt("");

...
public class FrameCareersManagementMaintenance extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(panelCRUD1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 580, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameCareersManagementMaintenance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrameCareersManagementMaintenance().setVisible(true);
            }
        });
    }
